...
class ExtractClusters(seamm.Node):
    ...
    --------
    TkExtractClusters,
    ExtractClusters, ExtractClustersParameters
    """
    ...
    def description_text(self, P=None):
        ...
        text = (
            ...
            "Extract Clusters step, including key parameters."
        )
    ...
    def analyze(self, indent="", **kwargs):
        ...
        printer.normal(
            __(
                "This is a placeholder for the results from the Extract Clusters step",
                indent=4 * " ",
                wrap=True,
                dedent=False,
            )
