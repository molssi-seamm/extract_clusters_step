...
setup(
    ...
    url='https://github.com/molssi-seamm/extract_clusters_step',
    ...
    packages=find_packages(include=['extract_clusters_step']),
    ...
    entry_points={
        'org.molssi.seamm': [
            'Extract Clusters = extract_clusters_step:ExtractClustersStep',
        ],
        'org.molssi.seamm.tk': [
            'Extract Clusters = extract_clusters_step:ExtractClustersStep',
        ],
